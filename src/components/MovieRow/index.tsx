  ...
  return (
    <div className='relative z-0 space-y-1 group overflow-x-hidden'>
      ...
      <button
        ...
        className={`absolute left-0 z-30 w-12 h-72 flex items-center bg-zinc-950/80 opacity-0 transition-all group-hover:opacity-100 duration-300`}
      >
      ...
      <button
        ...
        className='absolute right-0 z-30 w-12 h-72 flex items-center bg-zinc-950/80 opacity-0 transition-all group-hover:opacity-100 duration-300'
      >
